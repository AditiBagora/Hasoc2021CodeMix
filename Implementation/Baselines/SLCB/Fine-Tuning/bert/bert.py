...
# %%
trainer = Trainer(BertForSequenceClassification, BertTokenizer, 'bert-base-multilingual-cased', **model_params)

# %%
import pandas as pd
train = pd.read_pickle("baseline2_codemix_flat.pkl")

# %%
test= df = pd.read_pickle("baseline2_codemix_flat_test.pkl")
...
tester = Tester(model_class = BertForSequenceClassification, model_file="trained_model_3", tokenizer_class=BertTokenizer, tokenizer_file="tokenizer_3")
